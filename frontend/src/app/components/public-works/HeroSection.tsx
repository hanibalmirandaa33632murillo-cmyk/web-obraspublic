    ...
    <section className="relative min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden">
      ...
      <nav className="relative z-20 container mx-auto px-6 py-6">
        <div className="flex items-center justify-between">
          ...
          {/* Muestra el nombre del usuario si esta logueado */}
          <div className="px-4 py-2 bg-cyan-500/10 border border-cyan-500/30 rounded-lg text-cyan-400 text-sm font-medium">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-4">
              <a href="#dashboard" className="px-8 py-4 bg-cyan-500 text-white rounded-lg hover:bg-cyan-600 transition-all font-medium shadow-lg shadow-cyan-500/20">
                Ver Dashboard
              </a>
              <a href="#modelo" className="px-8 py-4 bg-white/10 backdrop-blur-sm border border-white/20 text-white rounded-lg hover:bg-white/20 transition-all font-medium">
                Explorar Modelo
              </a>
            </div>
