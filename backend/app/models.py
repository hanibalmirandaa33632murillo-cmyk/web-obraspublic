...
from sqlalchemy import (
    ...
    Boolean, Text, UniqueConstraint, ForeignKey, CheckConstraint, DateTime
)
...
# ── NUEVO: Tabla de usuarios para login/registro ─────────────────────────────
class Usuario(Base):
    ...
    rol         = Column(String(50), nullable=False, default="viewer")  # admin | supervisor | viewer
